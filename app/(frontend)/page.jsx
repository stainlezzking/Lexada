      ...
      <main>
        ...
        <div>
            ...
            <div className="col-span-1 h-full items-center flex">
              <div className="space-y-5 lg:space-y-8">
                <div className="space-y-6">
                  <h1 className="title" data-aos="zoom-in-up">
                ...
                <Link className="text-white button w-fit " data-aos-delay="200" data-aos="fade-left" href="/about">
                  Read More
                </Link>
              </div>
            </div>
          ...
          <Section className="grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:gap-x-20 bg-background">
            <div className="col-span-1 h-full flex items-center max-md:order-2">
              <div className="space-y-10 max-w-[519px]">
                ...
                <Link data-aos-delay="200" data-aos="fade-right" className="text-white button w-fit" href="/">
                  Book Agent
                </Link>
              </div>
            </div>
          ...
          <Section className="space-y-[48px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[32px] relative overflow-x-hidden">
              <Service
                data-aos="fade-right"
              ...
              >
                <svg className="w-16" data-aos="flip-right" data-aos-delay="600" viewBox="0 0 66 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="66" height="66" className="fill-primary" />
                  <path
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-[27px]">
              {allBlogs.map((blog, i) => (
                <div className="col-span-1 max-w-[450px] w-full mx-auto" key={blog.id}>
                  <Blogspreview data-aos="fade-up" data-aos-delay={i * 200} url={blog.image} id={blog.id} title={blog.title} />
                </div>
              ))}
            </div>
          </Section>
          ...
          <Section className="grid grid-cols-1 lg:grid-cols-2 max-lg:gap-y-16 gap-x-16">
            ...
            <div className="space-y-8 col-span-1">
              ...
              <div className="space-y-6">
                <div className="space-y-5 rounded-2xl border border-gray p-[10px]" data-aos="fade-up" data-aos-delay="100">
                  <p>
                ...
                <div className="space-y-5 rounded-2xl border border-gray p-[10px]" data-aos="fade-up" data-aos-delay="200">
                  <p>
                ...
                <div className="space-y-5 rounded-2xl border border-gray p-[10px]" data-aos="fade-up" data-aos-delay="300">
                  <p>
          ...
          <Section className="grid grid-cols-1 md:grid-cols-2 md:p-0">
            ...
            <div className="bg-[#FFEBE9] col-span-1 md:h-[620px] max-md:py-20 flex items-center md:order-1">
              <div className=" space-y-8 page-padding">
                <div>
                  <h2 data-aos="fade-up" className=" font-bold md:font-black text-3xl md:text-[40px]/[48px] text-main">
                    Allow us find you <span className="text-primary">The Perfect Property</span>
                  </h2>
                  <p className="text-2xl" data-aos="fade-in" data-aos-delay="600">
                    Call an agent today!
                  </p>
                </div>
                <Link href="/inspection" data-aos="fade-right" data-aos-delay="800" className="text-white button w-fit">
                  Book Agent
                </Link>
              </div>
            </div>
